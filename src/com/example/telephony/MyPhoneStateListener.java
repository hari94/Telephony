		...
		case TelephonyManager.CALL_STATE_IDLE:
			...
			if(curr == 1)
			    ...
			    // Build notification
			        ...
			        .setStyle(new NotificationCompat.BigTextStyle().bigText("You've got new call(s) to log. Tap Here to view"))
			        .setContentText("You've got new call(s) to log. Tap Here to view")
			        .setContentIntent(pi)
